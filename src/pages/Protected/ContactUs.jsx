...
function ContactUs() {
  ...
  return (
    ...
    <div className={styles.section1}>
        <div>
            <img className={styles.section1img} src={require(`../../assets/images/contact.png`)}/>
        </div>
        {/* <!-- ----------------------------------------section2------------------------------------------------ --> */}
        <div className={styles.section2}>
            <div className={styles.divshadow}>
                <div className={styles.locationdiv}>
                    <div className={styles.locationdiv1} style={{marginBottom:'20px'}}>
                        <p className={styles.locationtitle}>USA</p>
                        <p className={styles.locationinfo}><span><img src={require(`../../assets/images/contact1.png`)}/></span>(+1) 123 456 7890</p>
                        <p className={styles.locationinfo}><span><img src={require(`../../assets/images/mail1.png`)}/></span>demo@gmail.com</p>
                        <p className={styles.locationinfo}><span style={{marginTop:'-12px'}}><img
                                    src={require(`../../assets/images/location1.png`)}/></span>Lorem ipsum dolor sit amet consectetur.
                            Vel<br/>elementum massa mauris augue pretium. Id.</p>
                    </div>
                    <div className={styles.locationdiv1}>
                        <p className={styles.locationtitle}>INDIA</p>
                        <p className={styles.locationinfo}><span><img src={require(`../../assets/images/contact1.png`)}/></span>(+91) 123 456 7890</p>
                        <p className={styles.locationinfo}><span><img src={require(`../../assets/images/mail1.png`)}/></span>demo@gmail.com</p>
                        <p className={styles.locationinfo}><span style={{marginTop:'-12px'}}><img
                                    src={require(`../../assets/images/location1.png`)}/></span>Lorem ipsum dolor sit amet consectetur.
                            Vel<br/>elementum massa mauris augue pretium. Id.</p>
