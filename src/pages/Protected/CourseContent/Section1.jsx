...
function Section1() {
  let title = useSelector((state) => state?.allData?.course_details?.title);
    ...
    <div>
      <div className={styles.section1}>
        <div className={styles.section1row1}>
          ...
          <p className={styles.section1smalltxt}>
        ...
        <div className={styles.section1row2}>
          <div className={styles.section1left}>
            <p className={styles.section1containertitle}>
              Artificial Intelligence
            </p>
            <p className={styles.secction1containerText}>{title}</p>
            <p className={styles.sectionsmalltext}>
              Machine Learning in Python offers a wide range of tools and
              libraries for various tasks, including Regression. One popular
              approach is Linear Regression, a fundamental technique for
              predicting numerical values based on input data.
            </p>
            <p className={styles.sec1profilename}>
              <span>
                <img src={profileNull} />
              </span>
